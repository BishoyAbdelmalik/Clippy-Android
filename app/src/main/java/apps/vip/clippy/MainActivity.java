...
//
//        System.out.println(s+" "+Patterns.WEB_URL.matcher(s).matches());
//        System.out.println(s+" "+ URLUtil.isValidUrl(s));
...
//        System.out.println(s+" "+Patterns.WEB_URL.matcher(s).matches());
//        System.out.println(s+" "+ URLUtil.isValidUrl(s));
//        s="www.something.something";
//        System.out.println(s+" "+Patterns.WEB_URL.matcher(s).matches());
//        System.out.println(s+" "+ URLUtil.isValidUrl(s));
//        s="http://something.something";
//        System.out.println(s+" "+Patterns.WEB_URL.matcher(s).matches());
//        System.out.println(s+" "+ URLUtil.isValidUrl(s));
//        s="ForegroundService.connected";
//        System.out.println(s+" "+Patterns.WEB_URL.matcher(s).matches());
//        System.out.println(s+" "+ URLUtil.isValidUrl(s));
//        s="192.168.0.27";
//        System.out.println(s+" "+Patterns.WEB_URL.matcher(s).matches());
